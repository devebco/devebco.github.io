...
// Select all slides
const slides = document.querySelectorAll(".slider111");
...
slides.forEach((slide, indx) => {
    slide.style.transform = `translateX(${inum * indx}%)`;
...
const prevSlideBtn = document.querySelector(".control-prev-btn");
// select next slide button
const nextSlideBtn = document.querySelector(".control-next-btn");

//console.log("prevSlideBtn -->",prevSlideBtn);
...
nextSlideBtn.addEventListener("click", function () {
    ...
    //   move slide by -100%
    slides.forEach((slide, indx) => {
        slide.style.transform = `translateX(${inum * (indx - curSlide)}%)`;
